...
!function (t, e) {
    ...
    var a = function () {
        ...
        return t.prototype.predict = function (t) {
            ...
            return e.tidy(function () {
                var n = r.preprocessInput(e.cast(t, "float32")), i = e.expandDims(n, 0),
        ...
        return i(r, t), r.prototype.preprocessInput = function (t) {
            ...
            return {offsets: t[0], heatmap: t[1], displacementFwd: t[2], displacementBwd: t[3]}
        }, r
    }(a);
    ...
    var h = ["nose", "leftEye", "rightEye", "leftEar", "rightEar", "leftShoulder", "rightShoulder", "leftElbow", "rightElbow", "leftWrist", "rightWrist", "leftHip", "rightHip", "leftKnee", "rightKnee", "leftAnkle", "rightAnkle"],
        d = h.length, m = h.reduce(function (t, e, r) {
            return t[e] = r, t
        }, {}),
    ...
    function g(t, e, r, n) {
        return {y: n.get(t, e, r), x: n.get(t, e, r + d)}
    }

    function b(t, e, r) {
        var n = g(t.heatmapY, t.heatmapX, t.id, r), i = n.y, o = n.x;
    ...
    function M(t, e, r, n) {
        return {y: w(Math.round(t.y / e), 0, r - 1), x: w(Math.round(t.x / e), 0, n - 1)}
    }
    ...
    function k(t, e, r, n, i, o, u, s) {
        ...
        for (var a = n.shape, l = a[0], f = a[1], c = function (t, e, r) {
            ...
            var m = M(p, o, l, f), y = g(m.y, m.x, r, i);
            p = x({x: m.x * o, y: m.y * o}, {x: y.x, y: y.y})
        }
        var v = M(p, o, l, f), b = n.get(v.y, v.x, r);
        return {position: p, part: h[r], score: b}
    }

    function O(t, e, r, n, i, o) {
        var u = e.shape[2], s = S.length, a = new Array(u), l = t.part, f = t.score, c = b(l, n, r);
        a[l.id] = {score: f, part: h[l.id], position: c};
        for (var p = s - 1; p >= 0; --p) {
            var d = S[p], m = E[p];
    ...
    function N(t, e, r, n, i, o, u, s) {
        ...
        for (var a = [], l = function (t, e, r) {
            for (var n = r.shape, i = n[0], o = n[1], u = n[2], s = new c(i * o * u, function (t) {
                return t.score
            }), a = 0; a < i; ++a) for (var l = 0; l < o; ++l) for (var f = 0; f < u; ++f) {
                var h = r.get(a, l, f);
                h < t || p(f, h, a, l, e, r) && s.enqueue({score: h, part: {heatmapY: a, heatmapX: l, id: f}})
            }
            return s
        }(u, R, t), f = s * s; a.length < o && !l.empty();) {
            var h = l.dequeue();
            if (!I(a, f, b(h.part, i, e), h.part.id)) {
                var d = O(h, t, e, i, r, n), m = j(a, f, d);
                a.push({keypoints: d, score: m})
            }
        }
        return a
    }
    ...
    function P(t) {
        ...
        return e.tidy(function () {
            var r, u, s = e.reshape(t, [n * i, o]), a = e.argMax(s, 0),
                l = e.expandDims(e.div(a, e.scalar(i, "int32")), 1),
                f = e.expandDims((r = a, u = i, e.tidy(function () {
    ...
    function q(t, r, n) {
        return e.tidy(function () {
            var i = function (t, r) {
                for (var n = [], i = 0; i < d; i++) {
                    var o = B(t.get(i, 0).valueOf(), t.get(i, 1).valueOf(), i, r), u = o.x, s = o.y;
                    n.push(s), n.push(u)
                }
    ...
    function A(t, e, r) {
        return u(this, void 0, void 0, function () {
            ...
            return s(this, function (s) {
                switch (s.label) {
                    case 0:
                        return n = 0, i = P(t), [4, Promise.all([t.buffer(), e.buffer(), i.buffer()])];
                    case 1:
                    ...
                    case 2:
                        return c = s.sent(), p = Array.from(function (t, e) {
                            ...
                            return n += t, {position: {y: c.get(e, 0), x: c.get(e, 1)}, part: h[e], score: t}
                        }), i.dispose(), f.dispose(), [2, {keypoints: d, score: n / d.length}]
                }
            })
        })
    }
    ...
    var V = [-123.15, -115.9, -103.06], Y = function (t) {
        function r() {
            return null !== t && t.apply(this, arguments) || this
        }
        ...
        return i(r, t), r.prototype.preprocessInput = function (t) {
            ...
            var e = t[0], r = t[1];
            return {offsets: t[2], heatmap: t[3], displacementFwd: e, displacementBwd: r}
        }, r
    }(a);
    var F = Number.NEGATIVE_INFINITY, K = Number.POSITIVE_INFINITY;
    ...
    function J(t, r) {
        var n = r[0], i = r[1], o = U(t), u = o[0], s = o[1], a = i / n, l = [0, 0, 0, 0], f = l[0], c = l[1], p = l[2],
            h = l[3];
        return s / u < a ? (f = 0, c = 0, p = Math.round(.5 * (a * u - s)), h = Math.round(.5 * (a * u - s))) : (f = Math.round(.5 * (1 / a * s - u)), c = Math.round(.5 * (1 / a * s - u)), p = 0, h = 0), {
            resized: e.tidy(function () {
                ...
                return r = e.pad3d(r, [[f, c], [p, h], [0, 0]]), e.image.resizeBilinear(r, [n, i])
    ...
    var Z = {architecture: "MobileNetV1", outputStride: 16, multiplier: .75, inputResolution: 257},
        $ = ["MobileNetV1", "ResNet50"], tt = {MobileNetV1: [8, 16, 32], ResNet50: [32, 16]},
        et = {MobileNetV1: [.5, .75, 1], ResNet50: [1]}, rt = [1, 2, 4];
    var nt = {flipHorizontal: !1}, it = {flipHorizontal: !1, maxDetections: 5, scoreThreshold: .5, nmsRadius: 20};
    var ot = function () {
        function t(t, r) {
            var n;
            ...
            return void 0 === e && (e = it), u(this, void 0, void 0, function () {
                ...
                return s(this, function (k) {
                    switch (k.label) {
                        ...
                        case 1:
                            return b = k.sent(), w = b[0], x = b[1], _ = b[2], S = b[3], [4, N(w, x, _, S, n, r.maxDetections, r.scoreThreshold, r.nmsRadius)];
                        case 2:
    ...
    t.decodeMultiplePoses = N, t.decodeSinglePose = A, t.MobileNet = l, t.partChannels = ["left_face", "right_face", "right_upper_leg_front", "right_lower_leg_back", "right_upper_leg_back", "left_lower_leg_front", "left_upper_leg_front", "left_upper_leg_back", "left_lower_leg_back", "right_feet", "right_lower_leg_front", "left_feet", "torso_front", "torso_back", "right_upper_arm_front", "right_upper_arm_back", "right_lower_arm_back", "left_lower_arm_front", "left_upper_arm_front", "left_upper_arm_back", "left_lower_arm_back", "right_hand", "right_lower_arm_front", "left_hand"], t.partIds = m, t.partNames = h, t.poseChain = y, t.load = function (t) {
        return void 0 === t && (t = Z), u(this, void 0, void 0, function () {
            return s(this, function (e) {
                return "ResNet50" === (t = function (t) {
                    ...
                    if (null == t.inputResolution && (t.inputResolution = 257), D(t.inputResolution), null == t.outputStride && (t.outputStride = 16), tt[t.architecture].indexOf(t.outputStride) < 0) throw new Error("Invalid outputStride " + t.outputStride + ". Should be one of " + tt[t.architecture] + " for architecture " + t.architecture + ".");
                    if (null == t.multiplier && (t.multiplier = 1), et[t.architecture].indexOf(t.multiplier) < 0) throw new Error("Invalid multiplier " + t.multiplier + ". Should be one of " + et[t.architecture] + " for architecture " + t.architecture + ".");
                    if (null == t.quantBytes && (t.quantBytes = 4), rt.indexOf(t.quantBytes) < 0) throw new Error("Invalid quantBytes " + t.quantBytes + ". Should be one of " + rt + " for architecture " + t.architecture + ".");
        ...
        var e = Q(t), r = e.minX, n = e.minY, i = e.maxX, o = e.maxY;
        return [{x: r, y: n}, {x: i, y: n}, {x: i, y: o}, {x: r, y: o}]
    }, t.scaleAndFlipPoses = L, t.scalePose = X, t.version = "2.2.2", Object.defineProperty(t, "__esModule", {value: !0})
});